			...
			<div class="panel-body" align="center">
				...
				<form class="form-horizontal form-inline" role="form">
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3" id="tipoVehi" > 
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control" size="25" id="marcaVehi"
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control hasDatepicker" size="25" id="yearVehi"
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control" size="25" id="chasisVehi"
									placeholder="Ingrese n&#250mero de Chasis"></div>
					</div><!--Fin del chasis -->

					<div class="row">
					  <div class="col-md-5 col-sm-5"><label for="tarjeVehi" class="controllabel hidden-xs">Tarjeta de circulaci&#243n</label> </div>
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control" size="25" id="tarjeVehi"
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control" size="25" id="emiTarjeVehi"
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control" size="25" id="emiPlacaVehi"
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control" size="25" id="motorVehi"
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"><input type="text" class="form-control" size="25" id="Vehi"
