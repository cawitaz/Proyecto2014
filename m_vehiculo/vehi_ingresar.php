				...
				<form class="form-horizontal form-inline" role="form" >
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"  > 
					  	<select id="tipoVehi" class="form-control" onfocus="cambiarColor(this)" onBlur="defectoColor (this)" title="Seleccione Tipo de Vehiculo">
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3"  > 
					  	<select id="estado" class="form-control" onfocus="cambiarColor(this)" onBlur="defectoColor (this)" title="Seleccione Estado de Vehiculo">
